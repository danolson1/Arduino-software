...
New in this version
-in version 19b, there was a bug where the software would "freeze" after a day or so.  I'm trying to fix this
-got rid of checkBlankButtons in readLightSensors subroutine
-rewrote temperature subroutine.  Now it has separate routines for initialization and reading.
