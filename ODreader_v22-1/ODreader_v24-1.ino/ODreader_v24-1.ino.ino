...
//#include <HttpClient.h> // used to be used for uploading data to internet, but not needed with ThingSpeak library (DO 3-23-18)
#include <Math.h>
...
void setup(void)
{
  ...
  // reset external watchdog timer by flashing yellowLED
  ...
  Ethernet.begin(mac, ip, dnsServer, gateway, subnet); // try to connect to the network
